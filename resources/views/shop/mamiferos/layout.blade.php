...
<div class="container-fluid p-0 m-0">     
  <div class="row justify-content-center m-3">
    <h1>Artículos para especies pequeñas</h1>
  </div> 
  <div>
    <nav class="navbar navbar-expand-lg navbar-light shadow-md d-flex justify-content-between height-auto">
      ...
      <div class="collapse navbar-collapse" id="menuCategoria">
        <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
          <li class="nav-item">
            <a class="nav-link" href="/shop/mamiferos/alimento">Alimento</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="/shop/mamiferos/transportadoras">Jaulas y trasnportadoras</a>
          </li>
        </ul>
